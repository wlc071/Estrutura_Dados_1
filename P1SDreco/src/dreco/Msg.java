...
public class Msg
{
    ...
    public static void menu_principal()
    {
        ...
        msg_nl("----------------------------------------------------------------------------");
        msg_nl("           01. Inserir            06. Especial 01         11. Especial 06");
        msg_nl("           02. Remover            07. Especial 02         12. Conta Sexo 2");
        msg_nl("           03. Consultar          08. Especial 03         13. Troca Dreco 1");
        msg_nl("           04. Inicializar        09. Especial 04         14. Listagem Dreco");
        msg_nl("           05. Tamanho            10. Especial 05         15. Remove Sexo 1");
        msg_nl("----------------------------------------------------------------------------");
        msg_central("Teoria de Conjuntos");
        msg_nl("----------------------------------------------------------------------------");
        msg_nl("           16. C-União            17. C-Intersecção      18. C-Diferença A-B");
        msg_nl("           19. C-Intercalação     20. C-Separação        21. C-Balance Line");
        msg_nl("           22. T-União            23. T-Intersecção      24. T-Diferença A-B");
        msg_nl("           25. T-Intercalação     26. T-Separação        27. T-Balance Line");
        msg_nl("----------------------------------------------------------------------------");
